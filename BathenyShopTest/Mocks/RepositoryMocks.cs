...
namespace BathenyShopTest.Mocks;
...
public class RepositoryMocks
{
    public static Mock<IPieRepository> GetPieRepository()
    {
        ...
        var mock = new Mock<IPieRepository>();
        mock.Setup(m => m.AllPies).Returns(pies);
        mock.Setup(m => m.PiesOfTheWeek).Returns(pies.Where(x => x.IsPieOfTheWeek));
        mock.Setup(m => m.GetPieById(It.IsAny<int>())).Returns(pies[0]);
